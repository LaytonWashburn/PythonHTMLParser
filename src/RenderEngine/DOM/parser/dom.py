...
from RenderEngine.tables.tables import TokenTypeTable,Transitiontable
import logging
...
class DOM:
    ...
    def __init__(self, tokens:list):
        ...
        self.token_type_table:TokenTypeTable = TokenTypeTable('src/RenderEngine/tables/html/parser_token_type_table.csv')
        self.transition_table:Transitiontable = Transitiontable('src/RenderEngine/tables/html/parser_transition_table.csv')
